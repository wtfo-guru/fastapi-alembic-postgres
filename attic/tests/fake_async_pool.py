...
from asyncsqlite import Connection
from asyncsqlite.pool import Pool
...
class FakeAsyncPool:
    ...
    @classmethod
    async def create_pool(cls, pool: Pool) -> "FakeAsyncPool":
        pool = cls(pool)
...
class FakePoolAcquireContent:
    def __init__(self, pool: FakeAsyncPool) -> None:
        self._pool = pool
